...
// configuration step. It creates a namespace called `tmp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tmp::cmake::project_name, tmp::cmake::project_version) };
